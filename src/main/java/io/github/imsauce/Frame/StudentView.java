...
public class StudentView extends javax.swing.JFrame {
    ...
    public StudentView(io.github.imsauce.Frame.Main mainx) {
        main = mainx;
    ...
    private void initComponents() {
        ...
        closeBT.setBackground(new java.awt.Color(195, 235, 255));
        closeBT.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/view.jpg"))); // NOI18N
        closeBT.setText("Close");
        closeBT.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
